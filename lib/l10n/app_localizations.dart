...
class AppLocalizations {
  ...
  // ── SETTINGS ──────────────────────────────────────────────────────────────
  String get notifikasiShalat     => isEn ? 'Prayer Notifications'          : 'Notifikasi Shalat';
  String get tampilan             => isEn ? 'Display'                        : 'Tampilan';
  String get modeGelap            => isEn ? 'Dark Mode'                      : 'Mode Gelap';
  String get modeGelapSubtitle    => isEn ? 'Dark display for eye comfort'   : 'Tampilan gelap untuk kenyamanan mata';
  String get ukuranFontQuran      => isEn ? "Qur'an Font Size"               : "Ukuran Font Al-Qur'an";
  ...
  String get resetSemuaPengaturan => isEn ? 'Reset All Settings'             : 'Reset Semua Pengaturan';
  String get resetSubtitle        => isEn ? 'Restore to default settings'    : 'Kembalikan ke pengaturan awal';
  ...
  String get resetBerhasil    => isEn ? 'Settings successfully reset': 'Pengaturan berhasil direset';

  // ── WAKTU SHALAT ──────────────────────────────────────────────────────────
  String get imsak           => 'Imsak';
  String get imsakSubtitle   => isEn ? 'Reminder before suhoor ends'    : 'Pengingat sebelum sahur berakhir';
  String get subuh           => isEn ? 'Fajr'    : 'Subuh';
  String get subuhSubtitle   => isEn ? 'Beginning of Fajr prayer time'  : 'Awal waktu shalat Subuh';
  String get terbit          => isEn ? 'Sunrise' : 'Terbit';
  String get terbitSubtitle  => isEn ? 'Sunrise — end of Fajr time'     : 'Matahari terbit — batas akhir Subuh';
  String get dhuha           => 'Dhuha';
  String get dhuhaSubtitle   => isEn ? '± 20 minutes after sunrise'     : '± 20 menit setelah matahari terbit';
  ...
  // ── SHALAT PAGE ───────────────────────────────────────────────────────────
  String get gagalMemuat        => isEn ? 'Failed to load schedule'    : 'Gagal memuat jadwal';
  ...
  String get autoGpsSubtitle    => isEn ? 'Auto-detect from your location' : 'Deteksi otomatis dari lokasi Anda';
  String get mendeteksi         => isEn ? 'Detecting...'               : 'Mendeteksi...';
  String get jamMenit           => isEn ? 'hr min'                     : 'jam menit'; // unused, pakai _formatCountdown

  // ── DZIKIR PAGE ───────────────────────────────────────────────────────────
  String get dzikirWirid        => isEn ? 'Dhikr & Wirid'              : 'Dzikir & Wirid';
  String get dzikirSubtitle     => isEn ? 'Morning, evening, and after prayer dhikr' : 'Dzikir pagi, petang, dan setelah shalat';
  String get progressHariIni    => isEn ? "Today's Progress"           : 'Progress Hari Ini';
  String get dzikirSelesai      => isEn ? 'of ${''}dhikr done'        : 'dzikir selesai'; // pakai helper
  ...
  String get selesaiAlhamdulillah => isEn ? 'Done! Alhamdulillah'      : 'Selesai! Alhamdulillah';
  ...
  // ── HADIST PAGE ───────────────────────────────────────────────────────────
  String get hadistArbain       => isEn ? 'Hadith Arbain Nawawi'       : 'Hadist Arbain Nawawi';
  String get hadistSubtitle     => isEn ? '40 selected hadiths for daily life' : '40 Hadist pilihan untuk kehidupan sehari-hari';
  ...
  String get tidakAdaHadist     => isEn ? 'No hadith found'            : 'Tidak ada hadist ditemukan';
  String get belumAdaFavorit    => isEn ? 'No favorite hadith yet'     : 'Belum ada hadist favorit';
  String get hadistDisalin      => isEn ? 'Hadith copied!'             : 'Hadist disalin!';
  String get teksArab           => isEn ? 'Arabic Text'                : 'Teks Arab';
  String get transliterasiLatin => isEn ? 'Latin Transliteration'      : 'Transliterasi Latin';
  ...
  String get kalkulatorSubtitle => isEn ? 'Calculate maal, income, fitrah & more' : 'Hitung zakat maal, penghasilan, fitrah & lainnya';
  String get wajibZakat         => isEn ? 'Zakat Required'             : 'Wajib Zakat';
  String get belumWajibZakat    => isEn ? 'Zakat Not Required Yet'     : 'Belum Wajib Zakat';
  ...
  // ── SURAT / QURAN PAGE ────────────────────────────────────────────────────
  String get cariSurat          => isEn ? 'Search surah, number, or meaning...' : 'Cari surat, nomor, atau arti...';
  String get belumAdaBookmark   => isEn ? 'No bookmarks yet'           : 'Belum ada bookmark';
  String get tandaiAyat         => isEn ? 'Bookmark your favorite verses while reading' : 'Tandai ayat favoritmu saat membaca';
  String get lanjutkanMembaca   => isEn ? 'Continue reading'           : 'Lanjutkan membaca';
  String get suratLengkap       => isEn ? 'Surahs · Complete'          : 'Surat · Lengkap';

  // ── KIBLAT PAGE ───────────────────────────────────────────────────────────
  String get arahKiblatTitle    => isEn ? 'Qibla Direction'            : 'Arah Kiblat';
  String get mendapatkanLokasi  => isEn ? 'Getting your location...'   : 'Mendapatkan lokasi Anda...';
  String get gagalLokasi        => isEn ? 'Failed to get location'     : 'Gagal mendapatkan lokasi';
  String get dataKiblatTidakAda => isEn ? 'Qibla data not available'   : 'Data kiblat tidak tersedia';
  String get dariUtara          => isEn ? 'from North'                 : 'dari Utara';
  String get kompasKompass      => isEn ? 'Compass not available'      : 'Kompas tidak tersedia';
  String get aktifkanKompas     => isEn ? 'Enable device compass sensor' : 'Aktifkan sensor kompas perangkat';
  ...
  String get ketukUntukHitung   => isEn ? 'Tap the circle to count dhikr' : 'Ketuk lingkaran besar untuk menghitung dzikir';
  ...
  String get asmaulHusnaSubtitle => isEn ? "99 Names of Allah the Almighty" : '99 Nama Allah Yang Maha Agung';
  String get progressHafalan    => isEn ? 'Memorization Progress'     : 'Progress Hafalan';
  String get cariNamaAllah      => isEn ? 'Search name of Allah...'   : 'Cari nama Allah...';
  String get tidakAdaHasil      => isEn ? 'No results'                : 'Tidak ada hasil';
  String get berhasilDisalin    => isEn ? 'Copied successfully!'      : 'Berhasil disalin!';
  String get pelajaran          => isEn ? 'Explanation'               : 'Penjelasan';

  // ── RAMADHAN PAGE ─────────────────────────────────────────────────────────
  String get catatanRamadhan    => isEn ? 'Ramadan Notes'             : 'Catatan Ramadhan';
  String get dataBerhasilDisimpan => isEn ? '✅ Data saved successfully' : '✅ Data berhasil disimpan';
  String get jurnalHarian       => isEn ? 'DAILY JOURNAL'             : 'JURNAL HARIAN';
  String get catatanIbadah      => isEn ? 'Ramadan Worship Journal'   : 'Catatan Ibadah Ramadhan';
  ...
  String get progressRamadhan   => isEn ? 'Ramadan Progress'          : 'Progress Ramadhan';
  ...
  String get doaHint            => isEn ? 'Prayers answered today...' : 'Doa yang dikabulkan hari ini...';
  String get momenSpesial       => isEn ? 'Special Moment'            : 'Momen Spesial';
  String get momenHint          => isEn ? 'A memorable moment today...' : 'Momen berkesan hari ini...';
  String get refleksi           => isEn ? 'Reflection & Self-evaluation' : 'Refleksi & Muhasabah';

  // ── PANDUAN IBADAH PAGE ───────────────────────────────────────────────────
  String get panduanIbadahTitle    => isEn ? 'Worship Guide'           : 'Panduan Ibadah';
  String get panduanIbadahSubtitle => isEn ? 'Complete guide to daily worship' : 'Pedoman lengkap ibadah sehari-hari';
  String get referensi             => isEn ? 'References'              : 'Referensi';

  // ── CHAT PAGE ─────────────────────────────────────────────────────────────
  String get tanyaIslam2        => isEn ? 'Ask ISLAM'                  : 'Tanya ISLAM';
  String get onlineSiap         => isEn ? 'Online · ready to answer'   : 'Online · siap menjawab';
  String get tanyaSeputarIslam  => isEn ? 'Ask About Islam'            : 'Tanya Seputar Islam';
  String get cobaTanya          => isEn ? 'Try asking:'                : 'Coba tanya:';
  String get chatHint           => isEn ? 'Ask something about Islam...' : 'Tanya sesuatu tentang Islam...';
  String get hapusPercakapan    => isEn ? 'Clear Conversation?'        : 'Hapus Percakapan?';
  String get semuaPesanDihapus  => isEn ? 'All messages will be deleted.' : 'Semua pesan akan dihapus.';
  ...
  String get updateTerbaru      => isEn ? 'Latest Update (v3.0)'       : 'Update Terbaru (v3.0)';
  String get dikembangkanDengan => isEn ? 'Developed with ❤️ for the Muslim Community' : 'Dikembangkan dengan ❤️ untuk Umat Muslim';
  String get copyright          => isEn ? '© 2026 Muslim App • Teal Edition' : '© 2026 Muslim App • Teal Edition';
  String get builtWithFlutter   => isEn ? 'Built with Flutter'         : 'Built with Flutter';

  // ── UMUM ──────────────────────────────────────────────────────────────────
  String get ganti              => isEn ? 'Change'    : 'Ganti';
  String get memuatJadwal       => isEn ? 'Loading prayer schedule...' : 'Memuat jadwal shalat...';
  String get mendeteksiLokasi   => isEn ? 'Detecting location...'      : 'Mendeteksi lokasi...';
  String get ok                 => 'OK';
