            ...
            headerSliverBuilder: (_, __) => [
              SliverAppBar(
                ...
                bottom: TabBar(
                  ...
                  tabs: [Tab(text: context.tr('Surat')), Tab(text: context.tr('Juz')), Tab(text: 'Bookmark')],
                ),
              ),
            ],
            body: TabBarView(
          ...
          child: Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: context.tr('Cari surat, nomor, atau arti...'),
        ...
        if (vm.isLoading)
          ...
          SliverFillRemaining(
            child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              TrText('Gagal memuat', style: GoogleFonts.poppins(color: c.textSecondary)),
              const SizedBox(height: 12),
              ElevatedButton(
      ...
      itemBuilder: (_, i) {
        ...
        return Container(
          ...
          child: ListTile(
            ...
            title: Text('${context.tr('Juz')} ${juz['juz']}',
      ...
      itemBuilder: (_, i) {
        ...
        return Container(
          ...
          child: ListTile(
            ...
            title: Text('${bm.namaSurat} · ${context.tr('Ayat')} ${bm.nomorAyat}',
                style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 14, color: c.onSurface)),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          TrText("Al-Qur'an Digital", style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
          Text('${total > 0 ? total : 114} ${context.tr('Surat')} · ${context.tr('Lengkap')}',
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Wrap(spacing: 6, runSpacing: 4, children: [
                  _tag(context.tr(surat.arti),             const Color(0xFFE8F5F2), _kTeal),
                  _tag('${surat.jumlahAyat} ${context.tr('Ayat')}', const Color(0xFFFFF3E0), _kGold),
                  _tag(_cap(context.tr(surat.tempatTurun)), const Color(0xFFE8F5E9), const Color(0xFF388E3C)),
                ]),
              ])),
